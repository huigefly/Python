...
class Client(Iface):
  ...
  def sayMsg(self, msg, type):
    ...
    Parameters:
     ...
     - type
    """
    self.send_sayMsg(msg, type)
    return self.recv_sayMsg()

  def send_sayMsg(self, msg, type):
...
class Processor(Iface, TProcessor):
  ...
  def process_sayMsg(self, seqid, iprot, oprot):
    ...
    iprot.readMessageEnd()
    result = sayMsg_result()
    result.success = self._handler.sayMsg(args.msg, args.type)
...
class sayMsg_args:
  ...
  thrift_spec = (
    ...
    (2, TType.STRING, 'type', None, "int", ), # 2
  )

  def __init__(self, msg=None, type=thrift_spec[2][4],):
    self.msg = msg
    self.type = type
